...
export const experience = [
  ...
  },
  {
    ...
    achievements: [
      "Created responsive and reusable screens using React.js, gaining hands-on experience with components, props, and state management",
      "Strengthened understanding of React by learning core concepts, best coding practices, and project structuring",
      "Contributed to real-world development tasks within the team, applying modern UI practices"
    ]
  }
];
